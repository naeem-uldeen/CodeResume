defmodule Garden do
  ...
  defp plants_at(_plants1, _plants2, i) when i < 0,
    do: {}
  ...
  defp plants_at(plants1, plants2, i) do
    ...
    plants =
      [Enum.at(plants1, i),     Enum.at(plants1, i + 1),
       Enum.at(plants2, i),     Enum.at(plants2, i + 1)]
      |> Enum.map(&plant/1)
      |> Enum.reject(&is_nil/1)

    List.to_tuple(plants)
  end
  ...
  def info(garden, students) do
    ...
    sorted = Enum.sort(students)

    build_garden(sorted, plants1, plants2, 0, %{})
  end
