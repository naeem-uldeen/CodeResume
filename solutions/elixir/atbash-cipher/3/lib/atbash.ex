defmodule Atbash do
  ...
  defp do_encode(<<h::utf8, t::binary>>, acc) do
    case atbash_char(h) do
      nil     -> do_encode(t, acc)
      encoded -> do_encode(t, acc <> <<encoded::utf8>>)
    end
  end
  ...
  defp group_by_five(<<h::utf8, t::binary>>, 5, acc),     do: group_by_five(t, 1, acc <> " " <> <<h::utf8>>)
  defp group_by_five(<<h::utf8, t::binary>>, count, acc), do: group_by_five(t, count + 1, acc <> <<h::utf8>>)
